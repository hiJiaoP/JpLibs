...
public class DistanceScrollView extends ScrollView {
    ...
    public DistanceScrollView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DistanceScrollView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(android.os.Message msg) {
            int scrollY = DistanceScrollView.this.getScrollY();
