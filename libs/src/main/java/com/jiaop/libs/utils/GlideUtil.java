...
import com.jiaop.libs.entities.GlideApp;
...
public class GlideUtil {
     ...
     * @param cornerType
     */
    public static void loadCornersImg(Context context, Uri url, ImageView imageView, int radius, int margin, RoundedCornersTransformation.CornerType cornerType) {
        GlideApp.with(context)
                .load(url)
                .apply(bitmapTransform(
                        new RoundedCornersTransformation(radius, margin, cornerType)))
     ...
     * @param cornerType
     */
    public static void loadCornersImg(Context context, int imgId, ImageView imageView, int radius, int margin, RoundedCornersTransformation.CornerType cornerType) {
        GlideApp.with(context)
                .load(imgId)
                .apply(bitmapTransform(
                        new RoundedCornersTransformation(radius, margin, cornerType)))
